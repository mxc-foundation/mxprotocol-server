...
function (_DivOverlay) {
  ...
  function Popup() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPopupOpen", function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onPopupClose", function (_ref2) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onRender", function () {
