...
function (_Component) {
  ...
  function ControlledLayer() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "layer", void 0);
...
function (_ControlledLayer) {
  ...
  function BaseLayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this2)), "addLayer", function (layer) {
    ...
    _this2.contextValue = _extends({}, props.leaflet, {
      layerContainer: {
        addLayer: _this2.addLayer.bind(_assertThisInitialized(_assertThisInitialized(_this2))),
        removeLayer: _this2.removeLayer.bind(_assertThisInitialized(_assertThisInitialized(_this2)))
      }
    });
    return _this2;
  }
...
function (_ControlledLayer2) {
  ...
  function Overlay(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this3)), "addLayer", function (layer) {
    ...
    _this3.contextValue = _extends({}, props.leaflet, {
      layerContainer: {
        addLayer: _this3.addLayer.bind(_assertThisInitialized(_assertThisInitialized(_this3))),
        removeLayer: _this3.removeLayer.bind(_assertThisInitialized(_assertThisInitialized(_this3)))
      }
    });
    return _this3;
  }
...
function (_MapControl) {
  ...
  function LayersControl(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this4)), "controlProps", void 0);

    _this4.controlProps = {
      addBaseLayer: _this4.addBaseLayer.bind(_assertThisInitialized(_assertThisInitialized(_this4))),
      addOverlay: _this4.addOverlay.bind(_assertThisInitialized(_assertThisInitialized(_this4))),
      leaflet: props.leaflet,
      removeLayer: _this4.removeLayer.bind(_assertThisInitialized(_assertThisInitialized(_this4))),
      removeLayerControl: _this4.removeLayerControl.bind(_assertThisInitialized(_assertThisInitialized(_this4)))
    };
    return _this4;
  }
