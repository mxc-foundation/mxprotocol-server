...
var (
	pattern_MoneyService_ModifyMoneyAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "money", "modify_account", "money_abbr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MoneyService_GetChangeMoneyAccountHistory_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "money", "change_history", "money_abbr"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_MoneyService_GetActiveMoneyAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "money", "active_account", "money_abbr"}, "", runtime.AssumeColonVerbOpt(true)))
)
