...
type GetDeviceListResponse struct {
	DevList              string           `protobuf:"bytes,1,opt,name=dev_list,json=devList,proto3" json:"dev_list,omitempty"`
...
func (m *GetDeviceListResponse) GetDevList() string {
	if m != nil {
		return m.DevList
	}
	return ""
...
type GetDeviceProfileResponse struct {
	DevProfile           string           `protobuf:"bytes,1,opt,name=dev_profile,json=devProfile,proto3" json:"dev_profile,omitempty"`
	UserProfile          *ProfileResponse `protobuf:"bytes,2,opt,name=user_profile,json=userProfile,proto3" json:"user_profile,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
...
func (m *GetDeviceProfileResponse) GetDevProfile() string {
	if m != nil {
		return m.DevProfile
	}
	return ""
...
type SetDeviceModeResponse struct {
	DevMode              string           `protobuf:"bytes,1,opt,name=dev_mode,json=devMode,proto3" json:"dev_mode,omitempty"`
	UserProfile          *ProfileResponse `protobuf:"bytes,2,opt,name=user_profile,json=userProfile,proto3" json:"user_profile,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
...
func (m *SetDeviceModeResponse) GetDevMode() string {
	if m != nil {
		return m.DevMode
	}
	return ""
